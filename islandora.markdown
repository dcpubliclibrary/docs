...
1. Open the text editor of your choice and open the dc_to_mods.xml template. Template can be retrieved from Github at DCPL/Islandora/Open Refine/dc_to_mods.xml <https://github.com/darkivist/DCPL/tree/master/Islandora>.
...
1. The splitting process utilizes Terminal and Python scripts which can be found on GitHub at DCPL/Islandora. An example Terminal for splitting appears below the instructions. <https://github.com/darkivist/DCPL/tree/master/Islandora>
...
7. Open the Python script create_directories.py in the text editor of your choice. Follow the prompts in the script to enter the folder location and files names. Save to a convenient location.
...
12. Go back to Terminal and run the rename_mods.py script. 
